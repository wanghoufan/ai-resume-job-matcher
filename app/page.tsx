...
export default function Home() {
  ...
  return <main>
    ...
    <footer><span>AI 超级求职助手</span><p>让准备有方向，让机会看得见。</p></footer>
  </main>;
}
