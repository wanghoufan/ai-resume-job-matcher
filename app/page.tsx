...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero" id="top"><div className="hero-copy"><p className="eyebrow">01 / YOUR NEXT ROLE</p><h1>让每一份履历<br/><em>向理想岗位校准。</em></h1><p className="hero-lede">上传你的简历和目标职位。AI 会将经历、能力与机会重新连线，给出下一步最值得投入的准备。</p><div className="hero-links"><a href="#workbench" className="text-link">开始岗位校准 <span>↓</span></a><a href="/resume-sites/new" className="text-link resume-site-link">生成在线简历 <span>↗</span></a></div></div><div className="hero-orbit" aria-hidden="true"><div className="orbit-ring ring-one"/><div className="orbit-ring ring-two"/><div className="orbit-core"><small>MATCH</small><strong>∞</strong><small>FUTURE</small></div><span className="satellite s-one"/><span className="satellite s-two"/><span className="orbit-caption">CAREER TRAJECTORY<br/>IS NOT A STRAIGHT LINE</span></div></section>
